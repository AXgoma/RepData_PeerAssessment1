...
```{r histogram without NA values, echo=TRUE}
...
```{r histogram with replaced NA values, echo=TRUE}
...
```{r activity pattern in weekday and weekend, message=FALSE, warning=FALSE, echo=TRUE}
