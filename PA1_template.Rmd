...
```{r summarise total steps, message=FALSE, warning=FALSE, echo=TRUE}
library(dplyr)
...
```{r histogram without NA values, echo=TRUE, fig.path='figure/'}
...
```{r daily activity pattern, echo=TRUE, fig.path='figure/'}
...
```{r maximum average step, echo=TRUE}
...
```{r histogram with replaced NA values, echo=TRUE, fig.path='figure/'}
...
```{r add days column, echo=TRUE, message=FALSE, warning=FALSE}
library(lubridate)
...
```{r activity pattern in weekday and weekend, message=FALSE, warning=FALSE, echo=TRUE, fig.path='figure/'}
